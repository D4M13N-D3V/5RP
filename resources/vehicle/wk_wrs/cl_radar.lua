...
Citizen.CreateThread( function()
    while true do 
        ...
        if ( IsDisabledControlPressed( 1, 70 ) and IsDisabledControlJustPressed( 1, 244 ) ) then 
            TriggerEvent( 'wk:radarRC' )
        end 

        -- LCtrl is not being pressed and M has just been pressed 
        if ( not IsDisabledControlPressed( 1, 70 ) and IsDisabledControlJustPressed( 1, 244 ) ) then 
            ResetFrontFast()
            ResetRearFast()
        end 
