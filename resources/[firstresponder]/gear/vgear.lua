...
local ManualLoadoutButton = 243         -- The button to be pressed to receive the loadout (default: 168 (F7))
...
local ReceivedLoadoutMessage = '^1Now On-Duty, Stay Safe Out There!' -- the message the player receives after getting the gear.
...
local spawnLoadoutList = {  
    ...
    {0x497FACC3, 25},	-- flares
    {0x5EF9FEC4, 500},  -- Combat Pistol
}
