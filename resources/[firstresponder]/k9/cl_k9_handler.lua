...
Citizen.CreateThread(function()
	while true do
		...
		-- Toggle Menu
		if IsControlJustPressed(1, 170) then -- LEFTALT + Z
			TriggerServerEvent('K9:SendMenuToggle')
		end

		-- Follow Key --
		if IsControlJustPressed(1, 74) and not IsPlayerFreeAiming(PlayerId())  and current_dog ~= nil then
			TriggerEvent("K9:Follow")
		end

		-- Attacking Key --
		if IsPlayerFreeAiming(PlayerId()) and IsControlJustPressed(1, 74) and current_dog ~= nil then
