...
AddEventHandler('bucheron:drawGetBois', function (qteBois)
	...
	if qteBois < 45 then
		...
		ClearPrints()
		SetTextEntry_2("STRING")
		AddTextComponentString("~r~No more wood to collect..")
		DrawSubtitleTimed(2000, 1)
	end
end)
...
AddEventHandler('bucheron:drawGetPlanche', function(qteBois, qtePlanche)
	...
	if qtePlanche < 45 and qteBois > 0 then
...
AddEventHandler('bucheron:drawSellPlanche', function (qte)
	...
	if qte > 0 then
		...
		ClearPrints()
		SetTextEntry_2("STRING")
		AddTextComponentString("~g~Selling planks...")
		DrawSubtitleTimed(2000, 1)
	else
		ClearPrints()
		SetTextEntry_2("STRING")
		AddTextComponentString("~r~You have no planks to sell!")
		DrawSubtitleTimed(2000, 1)
	end
end)
