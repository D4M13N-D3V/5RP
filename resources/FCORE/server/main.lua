path = {
    main = "C:/data", -- Change this!!
    users = "C:/data/users", -- Change this!!
    bans = "C:/data/bans", -- Change this!!
}
...
local defaultUser = {
    ...
    ["Extras"] = {
        ...
        jobs = {1,1,1},
        coords = {
            {x = -208.037, y = -1018.613, z = 30.138}, -- {x = -1858.91, y = -348.509, z = 49.8377},
            {x = -208.037, y = -1018.613, z = 30.138}, -- {x = -1858.91, y = -348.509, z = 49.8377},
            {x = -208.037, y = -1018.613, z = 30.138}, -- {x = -1858.91, y = -348.509, z = 49.8377},
        },
        jailtime = 0,
            ...
            if not new then
                ...
                for k,v in pairs(bantable["Anticheat"]) do
                    if v.identifier == id or v.license == license then
                        TriggerClientEvent("f:kick", source, id.."("..name.."), you are banned! Reason: "..v.reason.." - You can appeal if you wish.")
