...
jobs = {
	...
	{id=2, name='Police', pay={on=850,off=100}},
	{id=3, name='Pharmacist', pay=500},
	{id=4, name='futurjob2', pay=500},
	{id=5, name='futurjob', pay=500},
	{id=6, name='Farmer', pay=500},
	{id=7, name='Lumberjack', pay=500},
	{id=8, name='Gang', pay=1},
	{id=9, name='Miner', pay=500},
	{id=10, name='Fisher', pay=500},
	{id=11, name='Docker', pay=500},
	{id=12, name='Brewer', pay=500},
	{id=13, name='Vigneron', pay=400},
	{id=14, name='Livreur', pay=500},
	{id=15, name='Emergency', pay={on=850,off=100}},
	{id=16, name='Mechanic', pay=500},
	{id=17, name='Taxi', pay=400},
	{id=18, name='FBI', pay=850},
    {id=19, name="Courier", pay=700},
    {id=20, name="Pool Cleaner", pay=250}, 
    {id=21, name="Garbage Collector", pay=500},
    {id=22, name="Tow", pay=500},
}
...
function createUser(source, data)
	...
	f.getName = function()
		return self.identity.fname.." "..self.identity.sname or GetPlayerName(self.source)
	end
