...
customs = {
    ...
    {title = "Engine", data = {
        {name = "EMS Upgrade, Level 1",mt = 11, mod = -1, cost = 5000},
        {name = "EMS Upgrade, Level 2",mt = 11, mod = 0, cost = 10000},
        {name = "EMS Upgrade, Level 3",mt = 11, mod = 1, cost = 15000},
        {name = "EMS Upgrade, Level 4",mt = 11, mod = 2, cost = 22000},
    }},
    {title = "Brakes", data = {
    ...
    {title = "Transmission", data = {
        ...
        {name = "Sports Transmission",mod = 1,mt =13, cost = 8500},
        {name = "Race Transmission",mod = 2,mt =13, cost = 10000},
    }},
    {title = "Horn", data = {
        ...
        {name = "Musical Horn 1",mt = 14, mod = 3,cost =850},
        {name = "Musical Horn 2",mt = 14, mod = 4,cost =850},
        {name = "Musical Horn 3",mt = 14, mod = 5,cost =850},
        {name = "Musical Horn 4",mt = 14, mod = 6,cost =850},
        {name = "Musical Horn 5",mt = 14, mod = 7,cost =850},
        {name = "Sadtrombone Horn",mt = 14, mod = 8,cost =850},
        {name = "Classical Horn 1",mt = 14, mod = 9,cost =850},
        {name = "Classical Horn 2",mt = 14, mod = 10,cost =850},
        {name = "Classical Horn 3",mt = 14, mod = 11,cost =850},
        {name = "Classical Horn 4",mt = 14, mod = 12,cost =850},
        {name = "Classical Horn 5",mt = 14, mod = 13,cost =850},
        {name = "Classical Horn 6",mt = 14, mod = 14,cost =850},
        {name = "Classical Horn 7",mt = 14, mod = 15,cost =850},
        {name = "Scaledo Horn",mt = 14, mod = 16,cost =850},
        {name = "Scalere Horn",mt = 14, mod = 17,cost =850},
    ...
    {title = "Suspension", data = {
        ...
        {name = "Street Suspension",mod = 1,mt =15, cost = 7500},
        {name = "Sport Suspension",mod = 2,mt =15, cost = 8000},
        {name = "Competition Suspension",mod = 3,mt =15, cost = 8500},
    }},
    {title = "Armour", data = {
        {name = "None",mt = 16, mod = -1,cost = 0},
        {name = "Armour Upgrade 20%",mt = 16, mod = 0, cost = 9000},
    }},
    {title = "Lights", data = {
        ["Xenon"] = {
    ...
    {title = "Respray", data = {
        ...
        ["Secondary Colours"] = {
            ...
            ["SMetal"] = { 
                {name = "Brushed Steel",colour = 117,cost = 2500},
                {name = "Brushed Black Steel",colour = 118,cost = 2500},
                {name = "Brushed Aluminum",colour = 119,cost = 2500},
                {name = "Pure Gold",colour = 158,cost = 7500},
                {name = "Brushed Gold",colour = 159,cost = 8500},
            },
        },
    }},
    {title = "Turbo", data = {
        {name = "None",bool = false,mt = 18, cost = 0},
        {name = "Turbo Tuning",bool = true,mt = 18, cost = 25000},
    }},
    {title = "Wheels", data = {
        ["Wheeltypes"] = {
            ["Sport"] = { 
            ...
            ["Offroad"] = { 
                {name = "Stock", wtype = 4, mt = 23, mod = -1, cost = 2500},
                {name = "Raider", wtype = 4, mt = 23, mod = 0, cost = 2500},
                {name = "Mudslinger", mt = 23, mod = 1, cost = 2500},
                {name = "Nevis", wtype = 4, mt = 23, mod = 2, cost = 2500},
                {name = "Cairngorm", wtype = 4, mt = 23, mod = 3, cost = 2500},
                {name = "Amazon", wtype = 4, mt = 23, mod = 4, cost = 2500},
                {name = "Challenger", wtype = 4, mt = 23, mod = 5, cost = 2500},
                {name = "Dunebasher", wtype = 4, mt = 23, mod = 6, cost = 2500},
                {name = "Fivestar", wtype = 4, mt = 23, mod = 7, cost = 2500},
                {name = "Rockcrawler", wtype = 4, mt = 23, mod = 8, cost = 2500},
                {name = "Milspecsteelie", wtype = 4, mt = 23, mod = 9, cost = 2500},
            },
            ["Tuner"] = { 
                {name = "Stock", wtype = 5, mt = 23, mod = -1, cost = 2500},
                {name = "Cosmo", wtype = 5, mt = 23, mod = 0, cost = 2500},
                {name = "Supermesh", wtype = 5, mt = 23, mod = 1, cost = 2500},
                {name = "Outsider", wtype = 5, mt = 23, mod = 2, cost = 2500},
                {name = "Rollas", wtype = 5, mt = 23, mod = 3, cost = 2500},
                {name = "Driffmeister", wtype = 5, mt = 23, mod = 4, cost = 2500},
                {name = "Slicer", wtype = 5, mt = 23, mod = 5, cost = 2500},
                {name = "Elquatro", wtype = 5, mt = 23, mod = 6, cost = 2500},
                {name = "Dubbed", wtype = 5, mt = 23, mod = 7, cost = 2500},
                {name = "Fivestar", wtype = 5, mt = 23, mod = 8, cost = 2500},
                {name = "Slideways", wtype = 5, mt = 23, mod = 9, cost = 2500},
                {name = "Apex", wtype = 5, mt = 23, mod = 10, cost = 2500},
                {name = "Stancedeg", wtype = 5, mt = 23, mod = 11, cost = 2500},
                {name = "Countersteer", wtype = 5, mt = 23, mod = 12, cost = 2500},
                {name = "Endov1", wtype = 5, mt = 23, mod = 13, cost = 2500},
                {name = "Endov2dish", wtype = 5, mt = 23, mod = 14, cost = 2500},
                {name = "Guppez", wtype = 5, mt = 23, mod = 15, cost = 2500},
                {name = "Chokadori", wtype = 5, mt = 23, mod = 16, cost = 2500},
                {name = "Chicane", wtype = 5, mt = 23, mod = 17, cost = 2500},
                {name = "Saisoku", wtype = 5, mt = 23, mod = 18, cost = 2500},
                {name = "Dishedeight", wtype = 5, mt = 23, mod = 19, cost = 2500},
                {name = "Fujiwara", wtype = 5, mt = 23, mod = 20, cost = 2500},
                {name = "Zokusha", wtype = 5, mt = 23, mod = 21, cost = 2500},
                {name = "Battlevill", wtype = 5, mt = 23, mod = 22, cost = 2500},
                {name = "Rallymaster", wtype = 5, mt = 23, mod = 23, cost = 2500},
            },
            ["Highend"] = { 
                {name = "Stock", wtype = 7, mt = 23, mod = -1, cost = 5000},
                {name = "Shadow", wtype = 7, mt = 23, mod = 0, cost = 5000},
                {name = "Hyper", wtype = 7, mt = 23, mod = 1, cost = 5000},
                {name = "Blade", wtype = 7, mt = 23, mod = 2, cost = 5000},
                {name = "Diamond", wtype = 7, mt = 23, mod = 3, cost = 5000},
                {name = "Supagee", wtype = 7, mt = 23, mod = 4, cost = 5000},
                {name = "Chromaticz", wtype = 7, mt = 23, mod = 5, cost = 5000},
                {name = "Merciechlip", wtype = 7, mt = 23, mod = 6, cost = 5000},
                {name = "Obeyrs", wtype = 7, mt = 23, mod = 7, cost = 5000},
                {name = "Gtchrome", wtype = 7, mt = 23, mod = 8, cost = 5000},
                {name = "Cheetahr", wtype = 7, mt = 23, mod = 9, cost = 5000},
                {name = "Solar", wtype = 7, mt = 23, mod = 10, cost = 5000},
                {name = "Splitten", wtype = 7, mt = 23, mod = 11, cost = 5000},
                {name = "Dashvip", wtype = 7, mt = 23, mod = 12, cost = 5000},
                {name = "Lozspeedten", wtype = 7, mt = 23, mod = 13, cost = 5000},
                {name = "Carboninferno", wtype = 7, mt = 23, mod = 14, cost = 5000},
                {name = "Carbonshadow", wtype = 7, mt = 23, mod = 15, cost = 5000},
                {name = "Carbonz", wtype = 7, mt = 23, mod = 16, cost = 5000},
                {name = "Carbonsolar", wtype = 7, mt = 23, mod = 17, cost = 5000},
                {name = "Carboncheetahr", wtype = 7, mt = 23, mod = 18, cost = 5000},
                {name = "Carbonsracer", wtype = 7, mt = 23, mod = 19, cost = 5000},
            },
            ["Lowrider"] = { 
                {name = "Stock", wtype = 2, mt = 23, mod = -1, cost = 5000},
                {name = "Flare", wtype = 2, mt = 23, mod = 0, cost = 5000},
                {name = "Wired", wtype = 2, mt = 23, mod = 1, cost = 5000},
                {name = "Triplegolds", wtype = 2, mt = 23, mod = 2, cost = 5000},
                {name = "Bigworm", wtype = 2, mt = 23, mod = 3, cost = 5000},
                {name = "Sevenfives", wtype = 2, mt = 23, mod = 4, cost = 5000},
                {name = "Splitsix", wtype = 2, mt = 23, mod = 5, cost = 5000},
                {name = "Freshmesh", wtype = 2, mt = 23, mod = 6, cost = 5000},
                {name = "Leadsled", wtype = 2, mt = 23, mod = 7, cost = 5000},
                {name = "Turbine", wtype = 2, mt = 23, mod = 8, cost = 5000},
                {name = "Superfin", wtype = 2, mt = 23, mod = 9, cost = 5000},
                {name = "Classicrod", wtype = 2, mt = 23, mod = 10, cost = 5000},
                {name = "Dollar", wtype = 2, mt = 23, mod = 11, cost = 5000},
                {name = "Dukes", wtype = 2, mt = 23, mod = 12, cost = 5000},
                {name = "Lowfive", wtype = 2, mt = 23, mod = 13, cost = 5000},
                {name = "Gooch", wtype = 2, mt = 23, mod = 14, cost = 5000},
            },
            ["Muscle"] = { 
...
function CustomsShop()
    Menu.SetupMenu("customs_main","LA Customs")
...
function subCustoms(title,data)
    ...
    Menu.SetupMenu("customs_submenu","LA Customs")
...
function CustomsColours()
    ...
    Menu.SetupMenu("main_colours","LA Customs")
...
function subPrimaryColours(title,data)
    currentCategory = {title="Respray",data=Colourdata}
    Menu.SetupMenu("primary_colours","LA Customs")
...
function subSecondaryColours(title,data)
    currentCategory = {title="Respray",data=Colourdata}
    Menu.SetupMenu("secondary_colours","LA Customs")
...
function displayPrimaryColours(title,data)
    currentCategory = {title=title,data=data}
    Menu.SetupMenu("display_pcs","LA Customs")
...
function displaySecondaryColours(title,data)
    currentCategory = {title=title,data=data}
    Menu.SetupMenu("display_scs","LA Customs")
...
function CustomsLights()
    ...
    Menu.SetupMenu("customs_lights","LA Customs")
...
function subCustomsLights(title,data)
    currentCategory = {title="Lights",data=Lightdata}
    Menu.SetupMenu("subcustoms_lights","LA Customs")
...
function displayCustomsLights(title,data,back)
    currentCategory = {title=title,data=data}
    Menu.SetupMenu("displaycustoms_lights","LA Customs")
...
function CustomsWheels()
    ...
    Menu.SetupMenu("customs_wheels","LA Customs")
...
function CustomsWheelTypes()
    currentCategory = {title="Wheels",data=Wheeldata}
    Menu.SetupMenu("customs_wheel_types","LA Customs")
...
function displayWheels(title,data,back)
    currentCategory = {title=title,data=data}
    Menu.SetupMenu("displaywheels","LA Customs")
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
emplacement_customs = { 
    {locked = false,name="LA Customs", colour=3, id=72, locked = false, outside = { x = -362.7962, y = -132.4005, z = 38.25239, heading = 71.187133}, inside = {x = -337.3863,y = -136.9247,z = 38.5737, heading = 269.455}},
    {locked = false,name="LA Customs", colour=3, id=72, locked = false, outside = { x = -1140.191, y = -1985.478, z = 12.72923, heading = 315.290466}, inside = {x = -1155.536,y = -2007.183,z = 12.744, heading = 155.413}},
    {locked = false,name="LA Customs", colour=3, id=72, locked = false, outside = { x = 716.4645, y = -1088.869, z = 21.92979, heading = 88.768}, inside = {x = 731.8163,y = -1088.822,z = 21.733, heading = 269.318}},
    {locked = false,name="LA Customs", colour=3, id=72, locked = false, outside = { x = 1174.811, y = 2649.954, z = 37.37151, heading = 300.0}, inside = {x = 1175.04,y = 2640.216,z = 37.32177, heading = 182.402}},
    {locked = false,name="LA Customs", colour=3, id=72, locked = false, outside = { x = 119.595, y = 6617.620, z = 31.4, heading = 220.0}, inside = {x = 110.449, y = 6626.991, z = 30.06, heading = 44.0}},
     {locked = false,name="Police Garage", colour=3, id=72, locked = false, outside = { x = 436.99951171875, y = -1014.1495361328, z = 28.683547973633, heading = 2.14040112249542 }, inside = {x = 436.45025634766, y = -997.272581787109, z = 25.76024055481, heading = 181.0523223877}},
}
