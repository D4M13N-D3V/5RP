...
cars = {
    {title = "Asian Cars", vehicles = {
        ...
        {name="2014 Lexus LX570", price=50500, model=GetHashKey("lx570")},
        ...
        {name="2015 Nissan GTR R35", price=150000, model=GetHashKey("gtr")},
    }},
    {title = "European Cars", vehicles = {
        --{name="1995 BMW M3 E36T", price=80000, model=GetHashKey("e36t")},
        {name="1995 BMW M5 E34", price=30000, model=GetHashKey("m5e34")},
        {name="1990 MB 600SEL", price=31500, model=GetHashKey("sel600")},
        --{name="1999 BMW 750iL E38", price=89000, model=GetHashKey("750il")},
        {name="2016 VW Golf GTI", price=24995, model=GetHashKey("mk7")},
        {name="2006 VW Beetle Turbo", price=42000, model=GetHashKey("beetle")},
        {name="2016 Mini CooperWorks", price=20700, model=GetHashKey("cooperworks")},
        {name="2001 Audi S4", price=36000, model=GetHashKey("b5s4")},
        {name="2002 MB C32 AMG", price=34000, model=GetHashKey("benzc32")},
        {name="2003 BMW M5 E39", price=41000, model=GetHashKey("m5")},
        {name="2012 Range Rover SC", price=60000, model=GetHashKey("rover")},
        {name="2013 Audi RS4 Avant", price=78540, model=GetHashKey("rs4")},
    }}, 
    {title = "European Cars 2", vehicles = {
        {name="15 Range Rover Vouge", price=71560, model=GetHashKey("vogue")},
        --{name="2012 Audi Q7 V12", price=160000, model=GetHashKey("q7")},
        {name="1982 Porsche 911 Turbo", price=150000, model=GetHashKey("turbo33")},
        --{name="2009 Audi RS6 Avant", price=200000, model=GetHashKey("rs6om")},
        {name="2013 Audi S8 FSI", price=46895, model=GetHashKey("s8")},
        {name="2012 MB C63 AMG", price=45960, model=GetHashKey("c63")},
        {name="2016 Maserati GhibliS", price=70600, model=GetHashKey("ghibli")},
        {name="13 AM Vanquish", price=105000, model=GetHashKey("amv12")},
        {name="16 Porsche 911 TurboS", price=125000, model=GetHashKey("911turbos")},
        {name="2017 BMW M4 GTS", price=2000000, model=GetHashKey("rmodm4gts")},
        {name="2013 Lambo LP570-4", price=250000, model=GetHashKey("gallardo")},        
        {name="16 Audi R8 V10", price=130000, model=GetHashKey("r8ppi")},
        {name="2015 Ferrari 488GTB", price=230000, model=GetHashKey("488gtb")},
        {name="2010 Lambo LP650-4", price=245000, model=GetHashKey("lp6504")},
    }},
    {title = "American Cars", vehicles = {
        {name="1991 Lincoln TownCar", price=4500, model=GetHashKey("towncar")},
        {name="2003 Ford CrownVic LX", price=5500, model=GetHashKey("crownvic")},
        {name="12 Chevy Silverado LTZ", price=25000, model=GetHashKey("silverado")},
        ...
        {name="1969 Chevy Camaro SS", price=50250, model=GetHashKey("ss350")},
        {name="1970 Dodge Challenger", price=135000, model=GetHashKey("rt440")},
        {name="1970 Plymouth HemiCuda", price=68500, model=GetHashKey("cuda")},
        --{name="1970 Chevy Chevelle SS", price=110000, model=GetHashKey("chevelle1970")},
        {name="1967 Ford GT500", price=70000, model=GetHashKey("gt500")},
        {name="69 Ford Mustang BOSS302", price=120000, model=GetHashKey("boss302")},
    }},
    {title = "American Cars 2", vehicles = {
        {name="Jeep TrailCat", price=110000, model=GetHashKey("trailcat")},
        {name="70 Dodge ChargerMagnum", price=62950, model=GetHashKey("magnum")},
        {name="2014 Cadillac Escalade", price=29560, model=GetHashKey("escalade")},
        {name="66 Shelby Cobra 427 SC", price=135000, model=GetHashKey("cobra")},
        {name="15 Chrysler 300CSRT8", price=35000, model=GetHashKey("300c")},
        {name="16 Dodge Charger RT", price=47560, model=GetHashKey("charger")},
        {name="2015 Jaguar F-Type", price=65206, model=GetHashKey("ftypec")},
        {name="2013 Ford F150 Raptor", price=62000, model=GetHashKey("fraptor")},
        {name="2016 Ford Mustang GT", price=35250, model=GetHashKey("musty5")},
        {name="2015 Corvette C7-Z06", price=82560, model=GetHashKey("vc7")},
        {name="15 Challenger Hellcat", price=84900, model=GetHashKey("hellcat")},
    }},
    {title = "GTA DLC", vehicles = {
        {name="RatLoader", price=22000, model=GetHashKey("ratloader")},
        {name="RatTruck", price=37500, model=GetHashKey("ratloader2")},
        ...
        {name="TrophyTruck2", price=1000000, model=GetHashKey("trophytruck2")},
    ...
    {title = "GTA Sports", vehicles = {
        ...
        {name="Elegy Sport", price=120000, model=GetHashKey("elegy2")},
    ...
    {title = "GTA Super", vehicles = {
        {name="Adder", price=2400000, model=GetHashKey("adder")},
        {name="Banshee 900R", price=290000, model=GetHashKey("banshee2")},
        {name="Bullet", price=290000, model=GetHashKey("bullet")},
        {name="Cheetah", price=3200000, model=GetHashKey("cheetah")},
        {name="Entity XF", price=3350000, model=GetHashKey("entityxf")},
        {name="ETR1", price=2950000, model=GetHashKey("sheava")},
        {name="FMJ", price=2890000, model=GetHashKey("fmj")},
        {name="Infernus", price=3250000, model=GetHashKey("infernus")},
        {name="Osiris", price=3500000, model=GetHashKey("osiris")},
        {name="RE-7B", price=3600000, model=GetHashKey("le7b")},
        {name="Reaper", price=3500000, model=GetHashKey("reaper")},
        {name="T20", price=3650000, model=GetHashKey("t20")},
        {name="Turismo R", price=3850000, model=GetHashKey("turismor")},
        {name="Tyrus", price=2750000, model=GetHashKey("tyrus")},
        {name="Vacca", price=2850000, model=GetHashKey("vacca")},
        {name="Voltic", price=3100000, model=GetHashKey("Voltic")},
        {name="X80 Proto", price=4100000, model=GetHashKey("prototipo")},
        {name="Zentorno", price=4500000, model=GetHashKey("zentorno")},
    }},
    ...
    {title = "GTA Lowriders", vehicles = {
        {name="Faction Donk", price=21000, model=GetHashKey("faction3")},
        {name="Slamvan3", price=21500, model=GetHashKey("slamvan3")},
        {name="Minivan2", price=21500, model=GetHashKey("minivan2")},
        {name="Sabre GT2", price=22500, model=GetHashKey("sabregt2")},
        {name="Tornado5", price=23500, model=GetHashKey("tornado5")},
        {name="Virgo2", price=23500, model=GetHashKey("virgo2")},
        {name="Faction LR", price=15000, model=GetHashKey("faction2")},
        {name="Moonbeam Van", price=25330, model=GetHashKey("moonbeam2")},
        {name="Primo2", price=24500, model=GetHashKey("primo2")},
        {name="Chino2", price=26500, model=GetHashKey("chino2")},
        {name="Buccaneer2", price=24500, model=GetHashKey("buccaneer2")},
        {name="Voodoo", price=26500, model=GetHashKey("Voodoo")},
    }},
    {title = "GTA Offroad", vehicles = {
        ...
        {name="Sandking", price=39000, model=GetHashKey("sandking2")},
        {name="Sandking XL", price=49000, model=GetHashKey("sandking")},
        {name="Trophy Truck", price=1405000, model=GetHashKey("trophytruck")},
    }}, 
    ...
    {title = "GTA Vans", vehicles = {
        {name="Bison", price=8900, model=GetHashKey("bison")},
        {name="Bobcat XL", price=6500, model=GetHashKey("bobcatxl")},
        {name="Gang Burrito", price=5500, model=GetHashKey("gburrito")},
        {name="Journey", price=7500, model=GetHashKey("journey")},
        {name="Minivan", price=7500, model=GetHashKey("minivan")},
        {name="Paradise", price=2000, model=GetHashKey("paradise")},
        {name="Rumpo", price=2500, model=GetHashKey("rumpo")},
        {name="Surfer", price=5600, model=GetHashKey("surfer")},
        {name="Youga", price=3500, model=GetHashKey("youga")},
    }},
    {title = "GTA Sedans", vehicles = {
        {name="Asea", price=5600, model=GetHashKey("asea")},
        {name="Fugitive", price=2800, model=GetHashKey("fugitive")},
        {name="Asterope", price=6500, model=GetHashKey("asterope")},
        {name="Glendale", price=6500, model=GetHashKey("glendale")},
        {name="Ingot", price=6500, model=GetHashKey("ingot")},
        {name="Intruder", price=6500, model=GetHashKey("intruder")},
        {name="Premier", price=8500, model=GetHashKey("premier")},
        {name="Primo", price=4500, model=GetHashKey("primo")},
        {name="Primo Custom", price=7500, model=GetHashKey("primo2")},
        {name="Schafter", price=6500, model=GetHashKey("schafter2")},
        {name="Tailgater", price=6500, model=GetHashKey("tailgater")},
        {name="Warrener", price=6500, model=GetHashKey("warrener")},
        {name="Washington", price=10000, model=GetHashKey("washington")},
        {name="Surge", price=4500, model=GetHashKey("surge")},
        {name="Super Diamond", price=45000, model=GetHashKey("superd")},
        {name="Stretch", price=55000, model=GetHashKey("stretch")},
    }}, 
    {title = "Motorcycles", vehicles = {
        {name="ATV", price=3900, model=GetHashKey("blazer")},
        {name="Faggio", price=1275, model=GetHashKey("faggio2")},
        {name="Sanchez", price=2300, model=GetHashKey("sanchez")},
		{name="Sanchez2", price=8500, model=GetHashKey("sanchez2")},
        {name="Rat Bike", price=5000, model=GetHashKey("ratbike")},
        {name="Enduro", price=6000, model=GetHashKey("enduro")},
        {name="Akuma", price=9900, model=GetHashKey("akuma")},
        {name="Bagger", price=9800, model=GetHashKey("bagger")},
        {name="Bati 801", price=12500, model=GetHashKey("bati")},
        {name="Bati 801RR", price=14000, model=GetHashKey("bati2")},
        {name="BF400", price=21000, model=GetHashKey("bf400")},
        {name="Carbon RS", price=26500, model=GetHashKey("carbonrs")},
        {name="Cliffhanger", price=26500, model=GetHashKey("cliffhanger")},
        {name="Daemon", price=26500, model=GetHashKey("daemon")},
        {name="Double T", price=26500, model=GetHashKey("double")},
        {name="Gargoyle", price=42000, model=GetHashKey("gargoyle")},
        {name="Hakuchou", price=35000, model=GetHashKey("hakuchou")},
        {name="Hexer", price=26500, model=GetHashKey("hexer")},
        {name="Innovation", price=50000, model=GetHashKey("innovation")},
        {name="Lectro", price=26500, model=GetHashKey("lectro")},
        {name="Nemesis", price=19000, model=GetHashKey("nemesis")},
        {name="PCJ-600", price=22000, model=GetHashKey("pcj")},
        {name="Ruffian", price=26500, model=GetHashKey("ruffian")},
        {name="Vindicator", price=65000, model=GetHashKey("vindicator")},
        {name="Diablous", price=75000, model=GetHashKey("diablous2")},
        {name="Street ATV", price=12000, model=GetHashKey("blazer4")},
        {name="Chimera", price=90000, model=GetHashKey("chimera")},
        {name="Sanctus", price=100000, model=GetHashKey("sanctus")},  
    }},
}
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
--==============================================================================================================================--
...
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
function Carshop()
    Menu.SetupMenu("carshop_main","LA Autos")
...
function subCarshop(title,cvehicles)
    ...
    Menu.SetupMenu("carshop_submenu","LA Autos")
...
emplacement_vehicleshop = {
    {name="Vehicle shop", colour=69, id=225, x=-33.491161346436,y=-1102.2437744141,z=26.6,inside={-46.56327,-1097.382,25.99875, 120.1953},exit={-31.849,-1090.648,25.998,322.345}},
}
