...
AddEventHandler("js:jail", function(JailTime)
    ...
    if DoesEntityExist(GetPlayerPed(-1)) then
        ...
        Citizen.CreateThread(function()
            ...
            SetEntityCoords(GetPlayerPed(-1), 1692.939, 2518.685, -120.839)
            IsJailed = true
            ...
            while JailTime > 0 and not removeSentence do
                ...
                local Distance = Vdist(1692.939, 2518.685, -120.839, coords['x'], coords['y'], coords['z'])
            ...
            SetEntityCoords(GetPlayerPed(-1), 1848.169, 2584.199, 45.672)
            IsJailed = false
