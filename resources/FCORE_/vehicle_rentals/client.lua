...
--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--==--
function carRental()
    Menu.SetupMenu("carrental_main","KAYAK Rentals")
...
function subRentals(title,cvehicles)
    ...
    Menu.SetupMenu("carrental_submenu","KAYAK Rentals")
...
emplacement_vehiclerentals = {
    {name="Vehicle rentals", colour=69, id=225, x=-313.784,y=-1034.885,z=30.8,inside={-306.299,-1015.769,29.66,248.38},exit={-306.299,-1015.769,29.66,248.38}},
    --{name="Vehicle rentals", colour=69, id=225, x=-904.39,y=-2337.38,z=6.71,inside={-905.96,-2333.15,6.71,62.03 62.16},exit={-905.96,-2333.15,6.71,62.16}},
}
    ...
    while true do
        ...
        for k,v in ipairs(emplacement_vehiclerentals) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.5001, 1.5001, 0.5001, 0, 255, 0,255, 0, 0, 0,0)
