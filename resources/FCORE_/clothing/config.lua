...
local clothing_shops = {
    {name="Clothing Store", id=73, x=1930.519, y=3731.839, z=33.2},
    {name="Clothing Store", id=73, x=1693.26, y=4822.27, z=42.5},
    {name="Clothing Store", id=73, x=125.83, y=-223.16, z=55.2},
    {name="Clothing Store", id=73, x=-710.16, y=-153.26, z=37.9},
    {name="Clothing Store", id=73, x=-821.69, y=-1073.90, z=11.9},
    {name="Clothing Store", id=73, x=-1192.81, y=-768.24, z=17.9},
    {name="Clothing Store", id=73, x=4.25, y=6512.88, z=32.2},
    {name="Clothing Store", id=73, x=425.471, y=-806.164, z=30.1},
    {name="Clothing Store", id=73, x=-1101.017, y=2710.264, z=19.5},
    {name="Clothing Store", id=73, x=1196.877, y=2709.760, z=38.8},
}
incircle = false
