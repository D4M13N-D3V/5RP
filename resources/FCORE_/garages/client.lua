...
insurance = {
  ...
  {name="2017 Honda Accord V6",cost=4000},
  {name="2017 Subaru BRZ t-S",cost=5000},
  {name="2014 Lexus LX570",cost=5000},
  {name="2015 Lexus GS350F",cost=5000},
  {name="2002 Honda NSX",cost=10000}, 
  {name="2015 Mitsubishi Evo X",cost=10000},
  {name="2006 Mitsubishi Evo IX",cost=10000},
  {name="2004 Subaru WRX STi",cost=10000},
  {name="2006 Subaru WRX STi",cost=10000},
  {name="2004 Nissan GT-R R34",cost=10000},
  {name="1998 Toyota Supra",cost=10000},
  {name="2015 Nissan GTR R35",cost=10000},
  --{name="1995 BMW M3 E36T",cost=8000},
  {name="1995 BMW M5 E34",cost=4000},
  {name="1990 MB 600SEL",cost=4000},
  --{name="1999 BMW 750iL E38",cost=8900},
  {name="2016 VW Golf GTI",cost=4000},
  {name="2006 VW Beetle Turbo",cost=4000},
  {name="2016 Mini CooperWorks",cost=4000},
  {name="2001 Audi S4",cost=4000},
  {name="2002 MB C32 AMG",cost=4000},
  {name="2003 BMW M5 E39",cost=4000},
  {name="2012 Range Rover SC",cost=5000},
  {name="2013 Audi RS4 Avant",cost=5000},
  {name="15 Range Rover Vouge",cost=5000},
  --{name="2012 Audi Q7 V12",cost=16000}, 
  {name="1982 Porsche 911 Turbo",cost=10000}, 
  --{name="2009 Audi RS6 Avant",cost=20000},
  {name="2013 Audi S8 FSI",cost=10000},
  {name="2012 MB C63 AMG",cost=10000},
  {name="2016 Maserati GhibliS",cost=10000}, 
  {name="13 AM Vanquish",cost=12500}, 
  {name="16 Porsche 911 TurboS",cost=12500},
  {name="2017 BMW M4 GTS",cost=12500},
  {name="2013 Lambo LP570-4",cost=15000},        
  {name="16 Audi R8 V10",cost=15000},
  {name="2015 Ferrari 488GTB",cost=15000},       
  {name="2010 Lambo LP650-4",cost=10000},
  {name="1991 Lincoln TownCar",cost=1000},
  {name="2003 Ford CrownVic LX",cost=1000},
  {name="12 Chevy Silverado LTZ",cost=1500},
  {name="2013 Ford Explorer V6",cost=1500},
  --{name="1968 Ford Mustang FB",cost=10000},
  {name="1969 Chevy Camaro SS",cost=4500},
  {name="1970 Dodge Challenger",cost=4500},
  {name="1970 Plymouth HemiCuda",cost=4500},
  --{name="1970 Chevy Chevelle SS",cost=11000},
  {name="1967 Ford GT500",cost=4500},  
  {name="69 Ford MustangBOSS302",cost=4500},
  {name="Jeep TrailCat",cost=10000},
  {name="70 Dodge ChargerMagnum",cost=8500},
  {name="2014 Cadillac Escalade",cost=2500},
  {name="66 Shelby Cobra 427 SC",cost=4000},
  {name="15 Chrysler 300CSRT8",cost=4000},
  {name="16 Dodge Charger RT",cost=4000},
  {name="16 Ford Focus RS",cost=4500},
  {name="2015 Jaguar F-Type",cost=4500},
  {name="2013 Ford F150 Raptor",cost=5000},       
  {name="2016 Ford Mustang GT",cost=5000},
  {name="2015 Corvette C7-Z06",cost=5000},
  {name="15 Challenger Hellcat",cost=5000},
  {name="RatLoader",cost=2200},
  {name="RatTruck", cost=1500},
  {name="Coquette3",cost=1500},
  {name="Feltzer3",cost=5000},
  {name="Guardian",cost=4500},
  {name="Contender",cost=4500},
  {name="TrophyTruck2",cost=4500},
  {name="Lurcher",cost=4500},
  {name="Btype",cost=4500},
  {name="Slamvan",cost=4500},
  {name="Slamvan2",cost=4500},
  {name="Sabre GT2",cost=4500},
  {name="Comet3",cost=9000},
  {name="Torero",cost=9500},
  {name="Osiris",cost=6000},
  {name="Elegy1",cost=5000},
  {name="SultanRS",cost=8500},
  {name="Specter",cost=5000},
  {name="Tempesta",cost=2000},
  {name="ItaliGTB2",cost=10000},
  {name="Cheetah2",cost=13000},
  {name="XA21",cost=15000},
  {name="Nero",cost=2000},
  ...
  {name="Cognoscenti Cabrio",cost=1250},
  ...
  {name="Baller LE A", cost=20000},
  {name="Baller LE", cost=20000},
  ...
  {name="Super Diamond",cost=1250},
  {name="Stretch",cost=1500},
  {name="Akuma",cost=900},
  ...
  {name="ATV",cost=390},
  {name="Faction Donk",cost=1250},
  {name="Slamvan3",cost=1250},
  {name="Minivan2",cost=1250},
  {name="Sabre GT2",cost=1250},
  {name="Tornado5",cost=1250},
  {name="Virgo2",cost=1250},
  {name="Faction LR",cost=1250},
  {name="Moonbeam Van",cost=1250},
  {name="Primo2",cost=1250},
  {name="Chino2",cost=1250},
  {name="Buccaneer2",cost=1250},
  {name="Voodoo",cost=1200},
  {name="Sanctus", cost=1000},
  {name="Rat Bike", cost=500},
  {name="Elegy Sport", cost=1200},
  {name="Chimera", cost=9000},
}
...
emplacement_garage = {
    {name="Public Garage", colour=1, scale=0.8, sprite=357, x=-333.55532836914,y=-779.07543945313,z=34.2,id=1,gname="Park [1]",cost=0,heading=0.0,maxslots=5}, -- Public Park
    {name="Public Garage", colour=1, sprite=357, x=1188.0881347656,y=-1570.5745849609,z=39.5,id=2,gname="Hospital [2]",cost=0,heading=0.0,maxslots=5}, -- Public Hospital
    {name="Public Garage", colour=1, sprite=357, x=1232.4792480469,y=2708.3212890625,z=38.3,id=3,gname="Sandy [3]",cost=0,heading=0.0,maxslots=5}, -- Public Sandy
    {name="Public Garage", colour=1, sprite=357, x=117.96788024902,y=6599.45703125,z=32.3,id=4,gname="Paleto [4]",cost=0,heading=-90.0,maxslots=5}, -- Public Paleto
    {name="Personal Garage", colour=3, sprite=357, x=947.13641357422,y=-1697.9788818359,z=30.4,id=5,gname="Industrial [5]",cost=120000,heading=-95.0,maxslots=10}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=520.40753173828,y=168.9965057373,z=99.7,id=6,gname="Apartment Complex [6]",cost=80000,heading=-110.0,maxslots=6}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=-676.56494140625,y=904.18371582031,z=230.9,id=7,gname="Hills [7]",cost=1500000,heading=-45.0,maxslots=12}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=258.68347167969,y=2589.7287597656,z=45.2,id=8,gname="Autoshop Garage [8]",cost=100000,heading=10.0,maxslots=8}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=-226.0922088623,y=6436.400390625,z=31.4,id=9,gname="Residential [9]",cost=50000,heading=225.0,maxslots=4}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=-833.24926757813,y=-392.95385742188,z=31.7,id=10,gname="Weazel [10]",cost=150000,heading=225.0,maxslots=12}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=-30.303638458252,y=2.1268248558044,z=71.5,id=11,gname="Small Garage [11]",cost=50000,heading=150.0,maxslots=4}, -- Personal
    {name="Personal Garage", colour=3, sprite=357, x=-84.019691467285,y=-820.99694824219,z=36.4,id=12,gname="Maze Tower [12]",cost=50000,heading=-365.0,maxslots=4}, -- Personal
}
...
emplacement_selling = {
    {name="Sell vehicles", colour=1, sprite=225, x=-44.919033050537,y=-1082.6441650391,z=26.9},
}

emplacement_claim = {    
    {name="Claim Insurance", colour=3, sprite=467, x=150.1743927002,y=-1040.1678466797,z=29.7},
}
