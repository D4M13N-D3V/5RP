...
local LicenseZero = {"Machete","Golfclub","Knuckle dusters","Knife","Dagger","Switchblade","Crowbar","Bat","Bottle","Hammer","Flashlight"}
local LicenseOne = {"Machete","Golfclub","Knuckle dusters","Knife","Dagger","Switchblade","Crowbar","Bat","Bottle","Hammer","Flashlight","Pistol","Pistol 50","SNS Pistol","Heavy Pistol","Revolver"}
local LicenseTwo = {"Machete","Golfclub","Knuckle dusters","Knife","Dagger","Switchblade","Crowbar","Bat","Bottle","Hammer","Flashlight","Pistol","Pistol 50","SNS Pistol","Heavy Pistol","Revolver","Smoke Grenade","Pump Shotgun","Sawn-off Shotgun","Bullpup Shotgun","Double-Barrel","Auto Shotgun"}
local LicenseThree = {"Machete","Golfclub","Knuckle dusters","Knife","Dagger","Switchblade","Crowbar","Bat","Bottle","Hammer","Flashlight","Pistol","Pistol 50","SNS Pistol","Heavy Pistol","Revolver","Smoke Grenade","Pump Shotgun","Sawn-off Shotgun","Bullpup Shotgun","Double-Barrel","Auto Shotgun","MicroSMG","SMG","Assault SMG","MG","Gusenberg"}
local LicenseFour = {"Machete","Golfclub","Knuckle dusters","Knife","Dagger","Switchblade","Crowbar","Bat","Bottle","Hammer","Flashlight","Pistol","Pistol 50","SNS Pistol","Heavy Pistol","Revolver","Smoke Grenade","Pump Shotgun","Sawn-off Shotgun","Bullpup Shotgun","Double-Barrel","Auto Shotgun","MicroSMG","SMG","Assault SMG","MG","Gusenberg","Assault Rifle","Carbine Rifle","Advanced Rifle","Special Carbine"}
