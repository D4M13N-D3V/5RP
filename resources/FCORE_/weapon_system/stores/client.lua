...
function MainGunMenu()
    Menu.SetupMenu("main_gun_menu","Los Angeles Guns")
...
function guns(cat)
    if cat ~= "f" then
        Menu.SetupMenu("guns_menu","Los Angeles Guns")
        Menu.Switch("main_gun_menu","guns_menu")
    else
        Menu.SetupMenu("guns_menu","LA Blackmarket")
...
weapons = {
    ...
    ["f"] = {
        ...
        {"UZI", 2, {name="UZI", price=120000,license=5,model="WEAPON_MICROSMG"}},
        {"AK47-U", 2, {name="AK47-U",price=200000,license=5,model="WEAPON_COMPACTRIFLE"}},
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
gun_emplacement = {
    {name="Ammunation", colour=1, id=110, x= -1117.81, y= 2698.16, z= 19.2},
    {name="Ammunation", colour=1, id=110, x= 1693.93, y= 3759.73, z= 35.2},
    {name="Ammunation", colour=1, id=110, x= 251.85, y= -49.87, z= 70.5},
    {name="Ammunation", colour=1, id=110, x= -1306.17, y= -394.16, z= 37.2},
    {name="Ammunation", colour=1, id=110, x= -662.22, y= -935.71, z= 22.5},
    {name="Ammunation", colour=1, id=110, x= -330.00, y= 6083.41, z= 32.1},
    {name="Ammunation", colour=1, id=110, x= 2567.91, y= 294.74, z= 109.3},
    {name="Ammunation", colour=1, id=110, x= -3171.67, y= 1087.66, z= 21.4},
    {name="Ammunation", colour=1, id=110, x= 842.40, y= -1033.12, z= 29.0},
    {name="Ammunation", colour=1, id=110, x= 21.70, y= -1107.41, z= 30.5},
    {name="Ammunation", colour=1, id=110, x= 810.15, y= -2156.88, z= 30.3},
}

gun_emplacement_grove = {
    {name="Stab City", colour=4, id=110, x=59.209079742432, y=3714.2170410156, z=39.754703521729},
}

sellweapons = {
    {name="Sell weapons", colour=2, id=434, x=19.142578125, y=-1104.2302246094, z=30.5},
    {name="Sell weapons", colour=2, id=434, x=846.16723632813, y=-1034.9733886719, z=29.0}, 
    {name="Sell weapons", colour=2, id=434, x=813.94311523438, y=-2158.876953125, z=30.3},
    {name="Sell weapons", colour=2, id=434, x=-666.05834960938, y=-933.73907470703, z=22.5},
    {name="Sell weapons", colour=2, id=434, x=-1303.5306396484, y=-390.9504699707, z=37.2},
    {name="Sell weapons", colour=2, id=434, x=254.81108093262, y=-46.906475067139, z=70.5},
    {name="Sell weapons", colour=2, id=434, x=-3174.9465332031, y=1084.7476806641, z=21.4},
    {name="Sell weapons", colour=2, id=434, x=-1121.7216796875, y=2697.1447753906, z=19.2},
    {name="Sell weapons", colour=2, id=434, x=1689.8410644531, y=3758.0588378906, z=35.2},
    {name="Sell weapons", colour=2, id=434, x=-334.26705932617, y=6082.1689453125, z=32.1},
    {name="Sell weapons", colour=2, id=434, x=2571.7854003906, y=292.71542358398, z=109.3},
}
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        for k,v in ipairs(gun_emplacement_grove) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.5001, 1.5001, 0.7555, 1555, 10, 0,255, 0, 0, 0,0)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 1.0)then
                    if (incircle == false) then
                        DisplayHelpText("Press ~INPUT_CONTEXT~ to buy weapons!")
                    end
        ...
        for k,v in ipairs(sellweapons) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 1.0001, 1555, 10, 100,150, 0, 0, 0,0)
                if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 1.0)then
                    if (incircle == false) then
