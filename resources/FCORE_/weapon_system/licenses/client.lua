...
licenses = {
    {"Level 1", {name="Level 1", price=5000,level=1}},
    {"Level 2", {name="Level 2", price=20000,level=2}},
    {"Level 3", {name="Level 3", price=75000,level=3}},
    {"Level 4", {name="Level 4", price=150000,level=4}}
}
license_menu = false
local licensebool = false
function license()
    Menu.SetupMenu("license_menu","LA Gun Licenses")
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
emplacement_license = {
    {name="Gun license", colour=5, id=434, x=12.699568748474, y=-1105.0811767578, z=30.5},
    {name="Gun license", colour=5, id=434, x=819.67834472656, y=-2155.8120117188, z=30.3},    
}
    ...
    while true do
        ...
        for k,v in ipairs(emplacement_license) do
            if(Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0)then
                DrawMarker(27, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.5001, 1.5001, 0.5001, 177, 202, 223,255, 0, 0, 0,0)
